...
static struct xnsyscall cobalt_syscalls[] = {
	...
	SKINCALL_DEF(sc_cobalt_mutexattr_destroy, cobalt_mutexattr_destroy, current),
	SKINCALL_DEF(sc_cobalt_mutexattr_gettype, cobalt_mutexattr_gettype, current),
	SKINCALL_DEF(sc_cobalt_mutexattr_settype, cobalt_mutexattr_settype, current),
	SKINCALL_DEF(sc_cobalt_mutexattr_getprotocol, cobalt_mutexattr_getprotocol, current),
	SKINCALL_DEF(sc_cobalt_mutexattr_setprotocol, cobalt_mutexattr_setprotocol, current),
	SKINCALL_DEF(sc_cobalt_mutexattr_getpshared, cobalt_mutexattr_getpshared, current),
	SKINCALL_DEF(sc_cobalt_mutexattr_setpshared, cobalt_mutexattr_setpshared, current),
	SKINCALL_DEF(sc_cobalt_condattr_init, cobalt_condattr_init, current),
	SKINCALL_DEF(sc_cobalt_condattr_destroy, cobalt_condattr_destroy, current),
	SKINCALL_DEF(sc_cobalt_condattr_getclock, cobalt_condattr_getclock, current),
	SKINCALL_DEF(sc_cobalt_condattr_setclock, cobalt_condattr_setclock, current),
	SKINCALL_DEF(sc_cobalt_condattr_getpshared, cobalt_condattr_getpshared, current),
	SKINCALL_DEF(sc_cobalt_condattr_setpshared, cobalt_condattr_setpshared, current),

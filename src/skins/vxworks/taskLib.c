...
{
    struct wind_task_iargs *iargs = (struct wind_task_iargs *)cookie, _iargs;
    ...
    if (!err)
	_iargs.entry(_iargs.arg0,_iargs.arg1,_iargs.arg2,_iargs.arg3,_iargs.arg4,
		     _iargs.arg5,_iargs.arg6,_iargs.arg7,_iargs.arg8,_iargs.arg9);

...
static xnsysent_t __systab[] = {
    ...
    [__native_task_suspend ] = { &__rt_task_suspend, __xn_exec_primary },
    ...
    [__native_queue_delete ] = { &__rt_queue_delete, __xn_exec_any },
    ...
    [__native_heap_delete ] = { &__rt_heap_delete, __xn_exec_any },

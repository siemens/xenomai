...

{
    ...
    alarm = xeno_h2obj_validate(rt_registry_fetch(ph.opaque),XENO_ALARM_MAGIC,RT_ALARM);
...

{
    ...
    intr = xeno_h2obj_validate(rt_registry_fetch(ph.opaque),XENO_INTR_MAGIC,RT_INTR);
...
static xnsysent_t __systab[] = {
    [__xeno_task_create ] = { &__rt_task_create, __xn_exec_init },
    [__xeno_task_bind ] = { &__rt_task_bind, __xn_exec_conforming },
    [__xeno_task_start ] = { &__rt_task_start, __xn_exec_any },
    [__xeno_task_suspend ] = { &__rt_task_suspend, __xn_exec_primary },
    [__xeno_task_resume ] = { &__rt_task_resume, __xn_exec_any },
    [__xeno_task_delete ] = { &__rt_task_delete, __xn_exec_conforming },
    [__xeno_task_yield ] = { &__rt_task_yield, __xn_exec_primary },
    [__xeno_task_set_periodic ] = { &__rt_task_set_periodic, __xn_exec_conforming },
    [__xeno_task_wait_period ] = { &__rt_task_wait_period, __xn_exec_primary },
    [__xeno_task_set_priority ] = { &__rt_task_set_priority, __xn_exec_any },
    [__xeno_task_sleep ] = { &__rt_task_sleep, __xn_exec_primary },
    [__xeno_task_sleep_until ] = { &__rt_task_sleep_until, __xn_exec_primary },
    [__xeno_task_unblock ] = { &__rt_task_unblock, __xn_exec_any },
    [__xeno_task_inquire ] = { &__rt_task_inquire, __xn_exec_any },
    [__xeno_task_notify ] = { &__rt_task_notify, __xn_exec_any },
    [__xeno_task_set_mode ] = { &__rt_task_set_mode, __xn_exec_primary },
    [__xeno_task_self ] = { &__rt_task_self, __xn_exec_any },
    [__xeno_task_slice ] = { &__rt_task_slice, __xn_exec_any },
    [__xeno_task_send ] = { &__rt_task_send, __xn_exec_primary },
    [__xeno_task_receive ] = { &__rt_task_receive, __xn_exec_primary },
    [__xeno_task_reply ] = { &__rt_task_reply, __xn_exec_primary },
    [__xeno_timer_start ] = { &__rt_timer_start, __xn_exec_lostage|__xn_exec_switchback },
    [__xeno_timer_stop ] = { &__rt_timer_stop, __xn_exec_lostage|__xn_exec_switchback },
    [__xeno_timer_read ] = { &__rt_timer_read, __xn_exec_any },
    [__xeno_timer_tsc ] = { &__rt_timer_tsc, __xn_exec_any },
    [__xeno_timer_ns2ticks ] = { &__rt_timer_ns2ticks, __xn_exec_any },
    [__xeno_timer_ticks2ns ] = { &__rt_timer_ticks2ns, __xn_exec_any },
    [__xeno_timer_inquire ] = { &__rt_timer_inquire, __xn_exec_any },
    [__xeno_timer_spin ] = { &__rt_timer_spin, __xn_exec_any },
    [__xeno_sem_create ] = { &__rt_sem_create, __xn_exec_any },
    [__xeno_sem_bind ] = { &__rt_sem_bind, __xn_exec_conforming },
    [__xeno_sem_delete ] = { &__rt_sem_delete, __xn_exec_any },
    [__xeno_sem_p ] = { &__rt_sem_p, __xn_exec_primary },
    [__xeno_sem_v ] = { &__rt_sem_v, __xn_exec_any },
    [__xeno_sem_broadcast ] = { &__rt_sem_broadcast, __xn_exec_any },
    [__xeno_sem_inquire ] = { &__rt_sem_inquire, __xn_exec_any },
    [__xeno_event_create ] = { &__rt_event_create, __xn_exec_any },
    [__xeno_event_bind ] = { &__rt_event_bind, __xn_exec_conforming },
    [__xeno_event_delete ] = { &__rt_event_delete, __xn_exec_any },
    [__xeno_event_wait ] = { &__rt_event_wait, __xn_exec_primary },
    [__xeno_event_signal ] = { &__rt_event_signal, __xn_exec_any },
    [__xeno_event_clear ] = { &__rt_event_clear, __xn_exec_any },
    [__xeno_event_inquire ] = { &__rt_event_inquire, __xn_exec_any },
    [__xeno_mutex_create ] = { &__rt_mutex_create, __xn_exec_any },
    [__xeno_mutex_bind ] = { &__rt_mutex_bind, __xn_exec_conforming },
    [__xeno_mutex_delete ] = { &__rt_mutex_delete, __xn_exec_any },
    [__xeno_mutex_lock ] = { &__rt_mutex_lock, __xn_exec_primary },
    [__xeno_mutex_unlock ] = { &__rt_mutex_unlock, __xn_exec_primary },
    [__xeno_mutex_inquire ] = { &__rt_mutex_inquire, __xn_exec_any },
    [__xeno_cond_create ] = { &__rt_cond_create, __xn_exec_any },
    [__xeno_cond_bind ] = { &__rt_cond_bind, __xn_exec_conforming },
    [__xeno_cond_delete ] = { &__rt_cond_delete, __xn_exec_any },
    [__xeno_cond_wait ] = { &__rt_cond_wait, __xn_exec_primary },
    [__xeno_cond_signal ] = { &__rt_cond_signal, __xn_exec_any },
    [__xeno_cond_broadcast ] = { &__rt_cond_broadcast, __xn_exec_any },
    [__xeno_cond_inquire ] = { &__rt_cond_inquire, __xn_exec_any },
    [__xeno_queue_create ] = { &__rt_queue_create, __xn_exec_lostage },
    [__xeno_queue_bind ] = { &__rt_queue_bind, __xn_exec_conforming },
    [__xeno_queue_delete ] = { &__rt_queue_delete, __xn_exec_lostage },
    [__xeno_queue_alloc ] = { &__rt_queue_alloc, __xn_exec_any },
    [__xeno_queue_free ] = { &__rt_queue_free, __xn_exec_any },
    [__xeno_queue_send ] = { &__rt_queue_send, __xn_exec_any },
    [__xeno_queue_recv ] = { &__rt_queue_recv, __xn_exec_primary },
    [__xeno_queue_inquire ] = { &__rt_queue_inquire, __xn_exec_any },
    [__xeno_heap_create ] = { &__rt_heap_create, __xn_exec_lostage },
    [__xeno_heap_bind ] = { &__rt_heap_bind, __xn_exec_conforming },
    [__xeno_heap_delete ] = { &__rt_heap_delete, __xn_exec_lostage },
    [__xeno_heap_alloc ] = { &__rt_heap_alloc, __xn_exec_conforming },
    [__xeno_heap_free ] = { &__rt_heap_free, __xn_exec_any },
    [__xeno_heap_inquire ] = { &__rt_heap_inquire, __xn_exec_any },
    [__xeno_alarm_create ] = { &__rt_alarm_create, __xn_exec_any },
    [__xeno_alarm_delete ] = { &__rt_alarm_delete, __xn_exec_any },
    [__xeno_alarm_start ] = { &__rt_alarm_start, __xn_exec_any },
    [__xeno_alarm_stop ] = { &__rt_alarm_stop, __xn_exec_any },
    [__xeno_alarm_wait ] = { &__rt_alarm_wait, __xn_exec_primary },
    [__xeno_alarm_inquire ] = { &__rt_alarm_inquire, __xn_exec_any },
    [__xeno_intr_create ] = { &__rt_intr_create, __xn_exec_any },
    [__xeno_intr_bind ] = { &__rt_intr_bind, __xn_exec_conforming },
    [__xeno_intr_delete ] = { &__rt_intr_delete, __xn_exec_any },
    [__xeno_intr_wait ] = { &__rt_intr_wait, __xn_exec_primary },
    ...
    [__xeno_pipe_write ] = { &__rt_pipe_write, __xn_exec_any },
    [__xeno_pipe_stream ] = { &__rt_pipe_stream, __xn_exec_any },
    [__xeno_misc_get_io_region ] = { &__rt_misc_get_io_region, __xn_exec_lostage },
    [__xeno_misc_put_io_region ] = { &__rt_misc_put_io_region, __xn_exec_lostage },
    [__xeno_timer_ns2tsc ] = { &__rt_timer_ns2tsc, __xn_exec_any },
    [__xeno_timer_tsc2ns ] = { &__rt_timer_tsc2ns, __xn_exec_any },
};

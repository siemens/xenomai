...
nohelp_text[] =
	"There is no help available for this Xenomai option.\n",
load_config_text[] =
...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different Xenomai\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than\n"
	"Xenomai's default, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different Xenomai\n"
	"configurations available on a single machine.\n"
	"\n"
...
int main(int ac, char **av)
{
	...
	sym = sym_lookup("XENO_VERSION", 0);
	sym_calc_value(sym);
	sprintf(menu_backtitle, "Xenomai %s configuration",
	...
	if (stat == 0) {
		...
		printf("\n\nYour Xenomai configuration changes were NOT saved.\n\n");

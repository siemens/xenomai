...
struct xnltt_evmap xnltt_evtable[] = {
    ...
    [xeno_ev_fault] = { "Xenomai fault", "thread=%s, location=%p, trap=%d", -1, xeno_evall },
    [xeno_ev_callout] = { "Xenomai callout", "type=%s, thread=%s", -1, xeno_evall },
    [xeno_ev_finalize] = { "Xenomai finalize", "%s -> %s", -1, xeno_evall },
    [xeno_ev_thrinit] = { "Xenomai thread init", "thread=%s, flags=0x%x", -1, xeno_evthr },
    ...
    [xeno_ev_thrsuspend] = { "Xenomai thread suspend", "thread=%s, mask=0x%x, timeout=%Lu, wchan=%p", -1, xeno_evthr },
    ...
    [xeno_ev_cpumigrate] = { "Xenomai CPU migrate", "thread=%s, cpu=%d", -1, xeno_evthr },
    [xeno_ev_sigdispatch] = { "Xenomai sigdispatch", "thread=%s, sigpend=0x%x", -1, xeno_evall },
    [xeno_ev_thrboot] = { "Xenomai thread begin", "thread=%s", -1, xeno_evthr },
    [xeno_ev_tmtick] = { "Xenomai timer tick", "runthread=%s", -1, xeno_evirq },
    [xeno_ev_sleepon] = { "Xenomai sleepon", "thread=%s, sync=%p", -1, xeno_evthr },
    [xeno_ev_wakeup1] = { "Xenomai wakeup1", "thread=%s, sync=%p", -1, xeno_evthr },
    [xeno_ev_wakeupx] = { "Xenomai wakeupx", "thread=%s, sync=%p", -1, xeno_evthr },
    [xeno_ev_syncflush] = { "Xenomai syncflush", "sync=%p, reason=0x%x", -1, xeno_evthr },
    [xeno_ev_syncforget] = { "Xenomai syncforget", "thread=%s, sync=%p", -1, xeno_evthr },
    [xeno_ev_lohandler] = { "Xenomai lohandler", "type=%d, task=%s, pid=%d", -1, xeno_evall },
    ...
    [xeno_ev_syscall] = { "Xenomai syscall", "thread=%s, skin=%d, call=%d", -1, xeno_evsys },
    [xeno_ev_shadowexit] = { "Xenomai shadow exit", "thread=%s", -1, xeno_evthr },
    [xeno_ev_thrsetmode] = { "Xenomai thread setmode", "thread=%s, clrmask=0x%x, setmask=0x%x", -1, xeno_evthr },
    ...
    [xeno_ev_addhook] = { "Xenomai add hook", "type=%d, routine=%p", -1, xeno_evall },
    [xeno_ev_remhook] = { "Xenomai remove hook", "type=%d, routine=%p", -1, xeno_evall },
    [xeno_ev_thrperiodic] = { "Xenomai thread speriod", "thread=%s, idate=%Lu, period=%Lu", -1, xeno_evthr },
    [xeno_ev_thrwait] = { "Xenomai thread wperiod", "thread=%s", -1, xeno_evthr },
    [xeno_ev_tmstart] = { "Xenomai start timer", "tick=%u ns", -1, xeno_evall },
    [xeno_ev_tmstop] = { "Xenomai stop timer", NULL, -1, xeno_evall },
    [xeno_ev_mark] = { "Xenomai **mark**", "%s", -1, xeno_evall },
    [xeno_ev_watchdog] = { "Xenomai watchdog", "runthread=%s", -1, xeno_evall },
    { NULL, NULL, -1, 0 },
};
